        ...
        <aside className="w-72 bg-white border-r border-slate-100 flex flex-col h-screen sticky top-0 shrink-0">
            ...
            <div className="p-8 pb-10">
                <div className="flex items-center gap-3 group cursor-pointer" onClick={() => navigate('/owner/dashboard')}>
                    <div className="w-10 h-10 rounded-xl bg-indigo-600 text-white flex items-center justify-center font-black text-xl italic shadow-lg shadow-indigo-100 group-hover:scale-105 transition-all duration-300">P</div>
                    <div>
                        <h1 className="text-xl font-black tracking-tighter text-slate-800 uppercase italic leading-none">
                            Prop<span className="text-indigo-600">Owner</span>
                        </h1>
                        <p className="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] mt-1">Portal Access</p>
                    </div>
                </div>
            </div>
